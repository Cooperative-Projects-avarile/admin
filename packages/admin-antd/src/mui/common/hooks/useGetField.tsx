...
import {
	...
	FieldSelectProps,
	FieldUploadProps,
} from "@/mui/components/form";
import { FieldDatePickerProps } from "@/mui/components/form/field-datePicker";
import { FieldEditorProps } from "@/mui/components/form/field-editor";
import { FieldMulProps } from "@/mui/components/form/field-mul";
import { FieldRadioGroupProps } from "@/mui/components/form/field-radio-group";
import { FieldSwitchProps } from "@/mui/components/form/field-switch";
import { FieldTextProps } from "@/mui/components/form/field-text-field";
import { InputType, getField } from "../utils/getField";
import { FieldAutocompleteProps } from "@/mui/components/form/field-autocompleteGoogle";
import { FieldRatingProps } from "@/mui/components/form/field-rating";
...
export const useGetField = (methods: UseFormReturn | null = null) => {
	const getFieldByFormConfig = (keyBase: string, item: FormConfigItem) => {
		...
		if (type === "select") {
			...
			const FieldItem = getField("rating");
			fieldNode = (
				<Stack spacing={1.5}>
					<FieldItem
						{...(fieldConfig as FieldRatingProps)}
						name={key}
						key={key}
					/>
				</Stack>
