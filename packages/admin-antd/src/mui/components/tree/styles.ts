...
export const TreeItemStyledIcon = styled(ListItemIcon)<TreeItemStyledIconProps>(
	({ size }) => ({
		minWidth: "auto",
		width: size,
		height: size,
...
export const TreeItemStyledDotIcon = styled("span")<TreeItemDotIconProps>(
	({ active, theme }) => ({
		width: 4,
		height: 4,
		borderRadius: "50%",
...
export const StyledIconify = styled(Iconify)<IconifyProps>({
	color: "red",
});
